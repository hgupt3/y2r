...
bool tracker_interfaces__msg__query_points__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tracker_interfaces.msg._query_points.QueryPoints", full_classname_dest, 48) == 0);
  }
  tracker_interfaces__msg__QueryPoints * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of QueryPoints */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tracker_interfaces.msg._query_points");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "QueryPoints");

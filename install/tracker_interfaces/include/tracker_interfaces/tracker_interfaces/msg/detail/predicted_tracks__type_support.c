...
size_t tracker_interfaces__msg__PredictedTracks__rosidl_typesupport_introspection_c__size_function__PredictedTracks__trajectory_z(
  const void * untyped_member)
{
  const rosidl_runtime_c__float__Sequence * member =
    (const rosidl_runtime_c__float__Sequence *)(untyped_member);
...
const void * tracker_interfaces__msg__PredictedTracks__rosidl_typesupport_introspection_c__get_const_function__PredictedTracks__trajectory_z(
  const void * untyped_member, size_t index)
{
  const rosidl_runtime_c__float__Sequence * member =
    (const rosidl_runtime_c__float__Sequence *)(untyped_member);
...
void * tracker_interfaces__msg__PredictedTracks__rosidl_typesupport_introspection_c__get_function__PredictedTracks__trajectory_z(
  void * untyped_member, size_t index)
{
  rosidl_runtime_c__float__Sequence * member =
    (rosidl_runtime_c__float__Sequence *)(untyped_member);
...
void tracker_interfaces__msg__PredictedTracks__rosidl_typesupport_introspection_c__fetch_function__PredictedTracks__trajectory_z(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const float * item =
    ((const float *)
    tracker_interfaces__msg__PredictedTracks__rosidl_typesupport_introspection_c__get_const_function__PredictedTracks__trajectory_z(untyped_member, index));
  float * value =
    (float *)(untyped_value);
  *value = *item;
}

void tracker_interfaces__msg__PredictedTracks__rosidl_typesupport_introspection_c__assign_function__PredictedTracks__trajectory_z(
  void * untyped_member, size_t index, const void * untyped_value)
{
  float * item =
    ((float *)
    tracker_interfaces__msg__PredictedTracks__rosidl_typesupport_introspection_c__get_function__PredictedTracks__trajectory_z(untyped_member, index));
  const float * value =
    (const float *)(untyped_value);
  *item = *value;
}

bool tracker_interfaces__msg__PredictedTracks__rosidl_typesupport_introspection_c__resize_function__PredictedTracks__trajectory_z(
  void * untyped_member, size_t size)
{
  rosidl_runtime_c__float__Sequence * member =
    (rosidl_runtime_c__float__Sequence *)(untyped_member);
...
static rosidl_typesupport_introspection_c__MessageMember tracker_interfaces__msg__PredictedTracks__rosidl_typesupport_introspection_c__PredictedTracks_message_member_array[6] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tracker_interfaces__msg__PredictedTracks, trajectory_z),  // bytes offset in struct
    NULL,  // default value
    tracker_interfaces__msg__PredictedTracks__rosidl_typesupport_introspection_c__size_function__PredictedTracks__trajectory_z,  // size() function pointer
    tracker_interfaces__msg__PredictedTracks__rosidl_typesupport_introspection_c__get_const_function__PredictedTracks__trajectory_z,  // get_const(index) function pointer
    tracker_interfaces__msg__PredictedTracks__rosidl_typesupport_introspection_c__get_function__PredictedTracks__trajectory_z,  // get(index) function pointer
    tracker_interfaces__msg__PredictedTracks__rosidl_typesupport_introspection_c__fetch_function__PredictedTracks__trajectory_z,  // fetch(index, &value) function pointer
    tracker_interfaces__msg__PredictedTracks__rosidl_typesupport_introspection_c__assign_function__PredictedTracks__trajectory_z,  // assign(index, value) function pointer
    tracker_interfaces__msg__PredictedTracks__rosidl_typesupport_introspection_c__resize_function__PredictedTracks__trajectory_z  // resize(index) function pointer
  },
  {
    "num_points",  // name

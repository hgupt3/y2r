...
typedef struct tracker_interfaces__msg__PredictedTracks
{
  ...
  /// Flattened (N*T,) x-coordinates in camera pixels
  rosidl_runtime_c__float__Sequence trajectory_x;
  /// Flattened (N*T,) y-coordinates in camera pixels
  rosidl_runtime_c__float__Sequence trajectory_y;
  /// Flattened (N*T,) z-coordinates (depth, 3D only)
  rosidl_runtime_c__float__Sequence trajectory_z;
  /// N
  int32_t num_points;
  /// T

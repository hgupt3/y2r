...
public:
  ...
  : msg_(msg)
  {}
  Init_PredictedTracks_num_points trajectory_y(::tracker_interfaces::msg::PredictedTracks::_trajectory_y_type arg)
  {
...
class Init_PredictedTracks_query_points
{
public:
  explicit Init_PredictedTracks_query_points(::tracker_interfaces::msg::PredictedTracks & msg)
  : msg_(msg)
  {}
  Init_PredictedTracks_trajectory_x query_points(::tracker_interfaces::msg::PredictedTracks::_query_points_type arg)
  {
    msg_.query_points = std::move(arg);
...
public:
  ...
  {}
  Init_PredictedTracks_query_points header(::tracker_interfaces::msg::PredictedTracks::_header_type arg)
  {
    msg_.header = std::move(arg);
    return Init_PredictedTracks_query_points(msg_);
  }
